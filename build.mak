export PJDIR := /Users/magictech/Desktop/pjproject
...
# OPENH264 flags
OPENH264_CFLAGS = -DPJMEDIA_HAS_OPENH264_CODEC=1 -I/Users/magictech/Desktop/nimit/h264/genrated_code/include 
OPENH264_LDFLAGS =  -L/Users/magictech/Desktop/nimit/h264/genrated_code/lib -lopenh264 -lstdc++
...
export PJ_INSTALL_LDFLAGS_PRIVATE := $(APP_THIRD_PARTY_LIBS) $(APP_THIRD_PARTY_EXT) -lopus -lopenh264 -lstdc++ -lm -lpthread  -framework CoreAudio -framework CoreFoundation -framework AudioToolbox -framework CFNetwork -framework UIKit -framework AVFoundation -framework UIKit -framework AVFoundation -framework CoreGraphics -framework QuartzCore -framework CoreVideo -framework CoreMedia -framework VideoToolbox -framework OpenGLES
