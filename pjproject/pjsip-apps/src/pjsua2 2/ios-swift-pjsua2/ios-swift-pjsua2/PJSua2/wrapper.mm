...
UIView* displayReceiverWindow(pj::VideoWindowHandle wid);
#endif
...
- (void)call_surface: (void(*)(int,pjmedia_vid_dev_index,int,pjsua_call_id))function {
    pjsua2.call_suerface(function);
}
...
UIView* displayReceiverWindow(pj::VideoWindowHandle wid){
    UIView *view = (__bridge UIView *)wid.VideoWindowHandle::handle.window;
    return view;
}
