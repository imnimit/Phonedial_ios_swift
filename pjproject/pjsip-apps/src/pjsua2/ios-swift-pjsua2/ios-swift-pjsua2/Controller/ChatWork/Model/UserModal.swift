...
class UserModal : Object{
    ...
    convenience init(id: String, receiverIdForChat: String,chatType: String, contactNumber: String, contactName: String, lastChatDateTime: String, lastMessage: String, lastMessageType: String, chatCounter: String, roomID: String) {
        self.init()
        self.id = id
