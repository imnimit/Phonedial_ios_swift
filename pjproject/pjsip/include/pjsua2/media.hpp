...
public:
    ...
    */
     ...
     *
     * Typecast from base class Media. This is useful for a*pplication written
...
public:
     ...
     *                    number of channels, and number o*f bits per sample.
     ...
     *
     * @pa*ram media             The object to be downcasted
     *
