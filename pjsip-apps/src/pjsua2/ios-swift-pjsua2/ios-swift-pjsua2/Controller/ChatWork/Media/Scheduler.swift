...
extension Scheduler {
	...
	//-------------------------------------------------------------------------------------------------------------------------------------------
	func message(_ chatId: String, _ chatType: String, _ text: String?, _ photo: UIImage?, _ video: URL?, _ audio: String?) {

        let values = ["workspaceId": "", "chatId": chatId, "chatType": chatType]
...
extension Scheduler {
	...
	private func upload(_ auth: [String: String], _ data: Data, _ mimeType: String, _ completion: @escaping (String?, String?, Error?) -> Void) {
		...
		AF.upload(multipartFormData: { multipart in
            ...
            multipart.append(data, withName: "files", fileName: randomString(length: 8), mimeType: mimeType)
